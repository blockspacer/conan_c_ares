...
# see https://github.com/conan-io/conan-center-index/tree/master/recipes/c-ares/all
class CAresConan(ConanFile):
    ...
    settings = "os_build", "os", "compiler", "build_type", "arch"
    ...
    def source(self):
        ...
        self.run('git clone --progress --depth 1 --branch {} --recursive --recurse-submodules {} {}'.format(self.version, self.repo_url, self.source_folder))
    ...
    def package_info(self):
        ...
        self.cpp_info.names["cmake_find_package"] = "c-ares"
        self.cpp_info.names["cmake_find_package_multi"] = "c-ares"
